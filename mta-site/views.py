...
class UpdateGraphMultiple(View):
    def get(self, request):
        ...
        exec(open('/home/MtaSite/MTA-SITE/static/Calculate_SteadyState.py').read())
        exec(open('/home/MtaSite/MTA-SITE/static/Plot_SteadyState.py').read())
        if len(sheet_transient_data) != 0:
            exec(open('/home/MtaSite/MTA-SITE/static/Calculate_Transient.py').read())
            exec(open('/home/MtaSite/MTA-SITE/static/Plot_Transient.py').read())
    ...
    def open_and_process_data(self):
        Data = pd.ExcelFile("/home/MtaSite/MTA-SITE/static/2018.xlsx")
        Factors = pd.ExcelFile("/home/MtaSite/MTA-SITE/static/Factors.xlsx")
        SolarCurve = pd.ExcelFile('/home/MtaSite/MTA-SITE/static/NYCAprilSolar_Data.xlsx').parse('Gaussian Expanded').iloc[0:96]
        LocalTrainProfiles = pd.ExcelFile('/home/MtaSite/MTA-SITE/static/LocalTrainProfiles.xlsx')
        ExpressTrainProfiles = pd.ExcelFile('/home/MtaSite/MTA-SITE/static/ExpressTrainProfiles.xlsx')
        Coefficients = pd.ExcelFile('/home/MtaSite/MTA-SITE/static/Gauss2Coefficients.xlsx').parse('Sheet1').iloc[1:22]
